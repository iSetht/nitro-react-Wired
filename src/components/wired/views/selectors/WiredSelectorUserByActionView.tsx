...
const ACTIONS = [
    ...
    { label: 'wiredfurni.params.action.4',    value: 4  }, // Awake
    ...
    { label: 'wiredfurni.params.action.8',    value: 10 }, // Lay
    { label: 'wiredfurni.params.action.9',    value: 11 }, // Swim
...
export const WiredSelectorUserByActionView: FC<{}> = props =>
{
    ...
    return (
        ...
        >
            ...
            { (isSign || isDance) &&
                <WiredParam titleKey={ isSign ? 'wiredfurni.params.sign_selection' : 'wiredfurni.params.dance_selection' }>
                    <WiredCheckbox
