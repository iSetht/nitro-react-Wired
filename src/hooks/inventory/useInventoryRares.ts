...
const useInventoryRareFurniState = () =>
{
        ...
        setGroupItems(prevValue =>
        {
            ...
            for(const item of parser.items)
            {
                ...
                else
                {
                    ...
                    addFurnitureItem(newValue, furniture, isUnseen(UnseenItemCategory.RARES, item.itemId));
    ...
    useMessageEvent<FurnitureListEvent>(FurnitureListEvent, event =>
    {
        ...
        setGroupItems(prevValue =>
        {
            ...
            for(const itemId of fragment.keys())
            {
                ...
                addFurnitureItem(newValue, item, isUnseen(UnseenItemCategory.RARES, itemId));
    ...
    useEffect(() =>
    {
        ...
        return () =>
        {
            if(resetCategory(UnseenItemCategory.RARES))
            {
                setGroupItems(prevValue =>
                {
                    const newValue = [ ...prevValue ];
...
export const useInventoryRares = () => useBetween(useInventoryRareFurniState);
